...
class EditDeliveryAddressTest extends WebTestCase
{
    public function testIfEditDeliveryAddressIsSuccessful(): void
    {
        ...
        $crawler = $client->request(Request::METHOD_GET, $urlGenerator->generate("account_edit_delivery_address"));
